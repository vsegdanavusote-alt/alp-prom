...
function renderClients(data) {
  ...
  tbody.innerHTML = data.map(c => `
    <tr onclick="openClientModal(${Number(c.id)})" style="cursor:pointer">
      ...
      <td>
        <button class="crm-btn crm-btn-sm" onclick="event.stopPropagation();openClientModal(${Number(c.id)})">✏️</button>
        <button class="crm-btn crm-btn-sm crm-btn-danger" onclick="event.stopPropagation();deleteClient(${Number(c.id)})">🗑</button>
      </td>
    </tr>
  `).join('');
}
...
function renderLeads(data) {
  ...
  tbody.innerHTML = data.map(l => `
    <tr onclick="openLeadModal(${Number(l.id)})" style="cursor:pointer">
      ...
      <td>
        <button class="crm-btn crm-btn-sm" onclick="event.stopPropagation();openLeadModal(${Number(l.id)})">✏️</button>
        <button class="crm-btn crm-btn-sm crm-btn-danger" onclick="event.stopPropagation();deleteLead(${Number(l.id)})">🗑</button>
      </td>
    </tr>
  `).join('');
}
...
function renderBuildings(data) {
  ...
  tbody.innerHTML = data.map(b => `
    <tr onclick="openBuildingModal(${Number(b.id)})" style="cursor:pointer">
      ...
      <td>
        <button class="crm-btn crm-btn-sm" onclick="event.stopPropagation();openBuildingModal(${Number(b.id)})">✏️</button>
        <button class="crm-btn crm-btn-sm crm-btn-danger" onclick="event.stopPropagation();deleteBuilding(${Number(b.id)})">🗑</button>
      </td>
    </tr>
  `).join('');
}
